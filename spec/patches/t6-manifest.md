...
```
- R23: The default manifest URL is `https://chriswessells.github.io/mcp-bin/manifest.json`. The `MCP_BIN_MANIFEST_URL` environment variable overrides this default.
```
...
| R23 (new) | Default manifest URL: `https://chriswessells.github.io/mcp-bin/manifest.json` |
