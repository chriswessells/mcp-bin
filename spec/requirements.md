...
2. Host the manifest at a public HTTPS URL (or submit to the default registry at `https://your-registry.example.com/manifest.json`).
...
- R30: The default manifest URL is `https://your-registry.example.com/manifest.json`. The `MCP_BIN_MANIFEST_URL` environment variable overrides this default.
